...
class Media {
    ...
    this.program = new Program(this.gl, {
      ...
      fragment: `
        ...
        void main() {
          ...
          // Image mask with rounded corners
          float d = roundedBoxSDF(uvImg - 0.5, vec2(0.5 - uBorderRadius), uBorderRadius);
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.y = (this.viewport.height * (baseHeight * this.scale)) / this.screen.height * 1.3;
    this.plane.scale.x = (this.viewport.width * (950 * this.scale)) / this.screen.width * 1.3;
